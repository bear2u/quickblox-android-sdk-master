...
public class CoreApp extends Application {
    ...
    public void initCredentials(){
        Log.d("KTH" ,  qbConfigs.getAppId() +","+ qbConfigs.getAuthKey() +","+ qbConfigs.getAuthSecret());
        Log.d("KTH" ,  qbConfigs.getApiDomain() +","+ qbConfigs.getChatDomain() +","+ ServiceZone.PRODUCTION);
        if (qbConfigs != null) {
